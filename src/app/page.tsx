...
export default async function Home() {
  ...
  const { data: items } = entryIds.length ? await supabase.from("sales_items").select("number, amount").in("sales_entry_id", entryIds) : { data: [] };
